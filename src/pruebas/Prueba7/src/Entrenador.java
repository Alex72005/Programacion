public class Entrenador extends Persona implements Deportista,Integrante {
    ...
    public void concentrarse() {
        System.out.println("El entrenador " + getNombre() + " " + getApellidos() + "está en la concentracion");
    }

    @Override
    public void comer() {
        System.out.println("El entrenador está comiendo");
    }

    @Override
    public void dormir() {
        System.out.println("El entrenador está durmiendo");
    } 
}
